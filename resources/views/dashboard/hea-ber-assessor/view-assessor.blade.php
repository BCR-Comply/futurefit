...
/*        background-color: #e2e8ed !important;*/
    ...
    <h4 class="page-title">ASSESSORS</h4>
            ...
            <div class="card _shadow-1">
                <div class="card-body mybody">
                    <div class="d-flex justify-content-end pb-3">
                        <a href="{{route('assessor.create')}}" class="btn _btn-primary pull px-3">ADD ASSESSOR</a>
                    </div>
                    <table id="assessor-datatable" class="table dt-responsive nowrap w-100">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>COMPANY</th>
