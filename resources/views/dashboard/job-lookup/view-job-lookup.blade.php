...
<style>
    ...
    <h4 class="page-title">JOBS (Measures)</h4>
            ...
            <div class="card _shadow-1">
                <div class="card-body mybody">
                    <div class="d-flex justify-content-end pb-3">
                        <a href="{{route('lookup.job.create')}}" class="btn _btn-primary pull px-3">ADD JOB (Measure)</a>
                    </div>
                    <table id="job-lookup-datatable" class="table dt-responsive nowrap w-100">
                        <thead>
                        <tr>
