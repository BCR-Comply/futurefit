...
@section('content')
    ...
    <div class="row mt-3">
        <div class="row d-flex flex-sm-row flex-column pe-0">
            @php
                ...
                if($lead_scheme){
                    $leadSId = $lead_scheme->id;
                }
                $schemeId = $property->batch->scheme ? $property->batch->scheme->id : null;
            @endphp
    ...
    <div class="row mt-2 px-2">
        <div class="card _shadow-2 my-1">
            <div class="row" style="min-height: 150px;">
                ...
                <div class="col-3 padding-15 border-right d-flex flex-column" style="position: relative;">
                    ...
                    <div style="position: absolute;right: 12px;">
                        <a class="editProps"
                            href="{{ route('lead.edit', \Illuminate\Support\Facades\Crypt::encrypt($property->id)) . '?back=' . (isset($_GET['back']) ? $_GET['back'] : '0') }}">Edit
                            Lead</a>
                    </div>
                </div>
            ...
            <div class="row border-top " style="min-height: 150px;">
                <div class="col-3 padding-15 border-right d-flex flex-column d-none">
                    <b class="mb-2">Client</b>
                    <p>{{ isset($property['client']) ? $property['client']['name'] : '' }}</p>
                </div>
                <div class="col-3 padding-15 border-right d-flex flex-column">
                    <b class="mb-2">Batch</b>
                    <p>{{ isset($property->batch) ? $property->batch->our_ref : '' }}</p>
                </div>
                <div class="col-3 padding-15 border-right d-flex flex-column">
                    <span class="d-flex flex-sm-row flex-column"><b>Created Date:&nbsp;</b>
                        <p>{{ date('d/m/Y', strtotime($property['start_date'])) }}</p>
                    </span>
                    <span class="d-flex flex-sm-row flex-column"><b>Expected Close Date:&nbsp;</b>
    ...
    <div class="row mt-2">
        ...
        <div class="col">
            <form method="POST" id="prop-status"
                action="{{ route('property.changePropertyStatus', \Illuminate\Support\Facades\Crypt::encrypt($property->id)) }}">

                @csrf
                <input type="hidden" name="type" value="property_status">
                <label class="mb-1" for="status">Lead Stage</label>
                @php
                $lead_statuss = [
                    'lead',
                    'appointment_booked',
                ...
                @endphp
                <select name="status" id="property_status" class="form-control lead_stage">
    ...
    <div class="row mt-2">
        <div class="col-3 d-flex flex-column">
            ...
            <div class="sidebarNotePost">
                <b title="Please, go to Edit Property to add Pre- and Post-BER">Pre BER</b>
                <p title="Please, go to Edit Property to add Pre- and Post-BER" style="color: #808080;">{{ $property['pre_ber'] }}</p>
            </div>
            <div class="mt-2 mb-5 sidebarNotePost">
                <b title="Please, go to Edit Property to add Pre- and Post-BER">Post BER</b>
                <p title="Please, go to Edit Property to add Pre- and Post-BER" style="color:#808080;">{{ $property['post_ber'] }}</p>
            </div>
        </div>
        <div class="col-9">
                        ...
                        <div class="table-responsive mt-2">
                            <table class="table table-bordered dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    @else
                                    <tr>
                                        <td colspan="5" class="text-center">No contractors added yet.</td>
                                    </tr>
                                    @endif
                                </tbody>
                            </table>
            ...
            <div class="col card _shadow-1 generalCols SurveyourTarget d-none">
                ...
                <div class="card _shadow-2 my-1">
                    <div class="d-flex flex-row flex-wrap pl-2 pt-1 pb-1">
                        <div id="survery-list-container measureBox">
                ...
                <div class="mybody mb-1">
                    <table class="table dt-responsive w-100" id="third_party_form_table">
                        ...
                        <tbody>
                            ...
                            @endforeach
                            @else
                            <tr><td colspan="5" class="text-center">No 3rd party forms added yet.</td></tr>
                            @endif
                        </tbody>
                    </table>
                </div>
                ...
                <div class="mybody mb-2" id="property-assessor-body">
                    <table class="table dt-responsive w-100" id="property-assessor-table">
                        ...
                        <tbody>
                            ...
                            @endforeach
                            @else
                            <tr><td colspan="11" class="text-center">No HEA/BER assessors added yet.</td></tr>
                            @endif
                        </tbody>
                    </table>
                </div>
            ...
            <div class="col card _shadow-1 generalCols emailTarget d-none">
                <h2>Email</h2>
                <a href="{{route('lead.createLeadEmail',['id'=>\Illuminate\Support\Facades\Crypt::encrypt($property->id)])}}" class="btn btn-sm _btn-primary float-end sendEmailBtn">Send Email</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-around">
                                    <a href="{{route('lead.leadViewEmail',['id'=>\Illuminate\Support\Facades\Crypt::encrypt($emailD->id)])}}" class="_btn-primary" style="padding: 4px 10px;">View</a>
                                    {{-- <a href="{{url('/delete-email?id='.$emailD->id)}}"><i class="fas fa-trash"></i></a> --}}
                                </div>
                            </td>
                        </tr>
                        {{-- <div class="modal email_container_{{$emailD->id}}" id="email_container_{{$emailD->id}}" tabindex="-1" aria-labelledby="email_container_{{$emailD->id}}Label" aria-hidden="true">
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header"><b>{{$emailD->to_subject ? $emailD->to_subject : "N/A"}}</b></div>
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    @else
                                                    <a href="{{$filesD->url}}" download="{{$filesD->url}}">{{$filesD->name}}</a>
                                                    @endif
                                                </div>
                                                @endforeach
                                            </div>
                                ...
                                <div class="modal-footer">
                                    <div class="d-flex justify-content-end">
                                        <button class="btn btn-secondary" onclick="closeModalEmail({{$emailD->id}})">Close</button>
                                    </div>
                                </div>
                              </div>
                            </div>
                ...
                <div class="card my-1 row pl-2 pt-2 pb-1" id="appointmentboxess"
                    ...
                    @endphp
                        <div class="mb-2 col-sm-12 col-lg-6 col-md-6 appointmentboxes" role="alert">
                            ...
                            <div class="d-flex justify-content-between align-items-center py-0">
                                <a aria-hidden="true" class="text-blues"
                                    href="{{ route('lead.deleteAppointment', $appointment['id']) }}"
                                    onClick="return confirm(`Are you sure you want to delete?`)"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </div>
                            <div class=" mt-1 d-flex flex-column">
            ...
            <div class="row ">
                <form id="third-party-formss2" method="POST" enctype="multipart/form-data"
                    action="{{ route('lead.createAppointment') }}">
                    @csrf
        ...
        <!--Lead Move Modal -->
        <div class="modal fade" id="leadMoveModal" tabindex="-1" aria-labelledby="leadMoveModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="p-3">
                    ...
                    @endphp
                    <form class="convert-lead-property" method="POST" enctype="multipart/form-data" action="{{ route('lead.to.property') }}">
                        @csrf
                        <input type="hidden" class="fk_property_id" name="fk_property_id"
                            value="{{ $property->id }}" required>
                        <div class="modal-body">
                        ...
                        <div class="d-flex gap-2 p-2 pt-0">
                            <button type="submit" class="btn _btn-primary w-100 mt-0 mb-0">Yes</button>
                            <button type="button" class="cancel-prop-convert btn _btn-primary sing-img w-100 mt-0 mb-0">No</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" id="reasonModal" tabindex="-1" aria-labelledby="reasonLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form class="reason-form" method="POST" enctype="multipart/form-data" action="{{ route('property.note.store') }}">
                        @csrf
                        <input type="hidden" class="property_id" name="property_id"
                            value="{{ $property->id }}">
                        <div class="modal-header d-flex justify-content-center">
                        ...
                        <div class="modal-body">
                            <textarea class="form-control" name="text" id="text" style="width: 100%;" rows="6" placeholder="Add Reason"></textarea>
                        </div>
                        <div class="modal-footer">
                            <div class="d-flex gap-2" style="width:100%">
                                <button type="submit" class="btn _btn-primary w-100 mt-0 mb-0">Save</button>
    ...
    $(document).on('click','.closeTimesheet', function(){
        ...
        $(document).ready(function() {
                ...
                if(confirm('Are you sure you want to change status?'))
                 {
                    ...
                    }else if(this.value == "not_interested" || this.value == "lost"){
                        $.ajax({
                            type: 'POST',
                    ...
                    this.value = '{{ $property->status }}';
                }
            });
            $(document).on("click",".cancel-prop-convert",function() {
                $("#prop-status").submit();
            });
                    ...
                    success: function(response) {
                        ...
                        if (response.success == true) {
                            ...
                            html +=
                                '<div class="d-flex justify-content-between align-items-center py-0">';
                            html += '    <a aria-hidden="true" class="text-blues" href="' +
                                '{{ route('lead.deleteAppointment', '') }}/' + response.data.id +
                                '" onClick="return confirm(`Are you sure you want to delete?`)"><i class="fa fa-trash" aria-hidden="true"></i></a>';
            ...
            var lastAssesId = localStorage.getItem('lastLeadAssesId');
            if(lastAssesId != null && storedFilter == "her") {
                toggleAssessorDetails(lastAssesId);
            }else {
                localStorage.setItem('lastLeadAssesId',null);
            }
        ...
        const toggleAssessorDetails = (id) => {
            ...
            localStorage.setItem('lastLeadAssesId',lAssessId);
        }
        ...
        function toggleEmailDetails(id){
            $('.email_container_'+id).modal('show');
        }
        function closeModalEmail(id){
            $('.email_container_'+id).modal('hide');
        }
    </script>
@endsection
@push('scripts')
