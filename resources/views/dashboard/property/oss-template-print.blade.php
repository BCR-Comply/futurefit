                ...
                <div class="row mt-3">
                    <div class="col-sm-12">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            @if(sizeof($data['oss_template']))
                                @foreach($data['oss_template'] as $oss_template)
                                    <tr>
                                        <td>
                            ...
                            <tr>
                                ...
                                <td>€ {{$data['oss_cost'] ? number_format($data['oss_cost']['total_cost_works'], 2) : ''}}</td>
                            </tr>
                            <tr>
                                <td style="text-align: right"><h5>VAT @13.5%:</h5></td>
                                <td>€ {{$data['oss_cost'] ? number_format($data['oss_cost']['vatcost'], 2) : ''}}</td>
                            </tr>
                            <tr>
                                <td style="text-align: right"><h5>Total cost of Works Including VAT @13.5%:</h5></td>
                                <td>€ {{$data['oss_cost'] ? number_format($data['oss_cost']['total_client_cost_work_contribution'], 2) : ''}}</td>
