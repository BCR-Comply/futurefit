                    ...
                    <div class="row cm">
                        <div class="col-sm-12">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <th style="{{ $style['tbl-padding'] }}">Description of Works (Supply & Fit)</th>
                                    <th style="{{ $style['tbl-padding'] }}border-left: 1px solid #fff !important;">Cost</th>
                                </thead>
                                <tbody>
                                    @php
                                    ...
                                    @if (sizeof($arr))
                                        @foreach ($arr as $oss_template)
                                            <tr>
                                                ...
                                                <td style="{{ $style['tbl-padding'] }}">€
                                                    {{ number_format($oss_template['cost_works'], 2) }}</td>
                                            </tr>
                                        @endforeach
                                    @endif
                                    @php
                                    ...
                                    @endphp
                                    <tr>
                                        <td style="{{ $style['tbl-padding'] }}text-align: left;"><span
                                                class="text-black fw-bold">Total cost of
                                                Works:</span></td>
                                        <td style="{{ $style['tbl-padding'] }}">€
                                            {{ $arr2 ? number_format($arr2['total_cost_works'], 2) : '' }}</td>
                                    </tr>
                                    <tr>
                                        <td style="{{ $style['tbl-padding'] }}text-align: left;"><span
                                                class="text-black fw-bold">VAT @13.5%:</span>
                                        </td>
                                        <td style="{{ $style['tbl-padding'] }}">€
                                            {{ $arr2 ? number_format($arr2['vatcost'], 2) : '' }}</td>
                                    </tr>
                                    <tr>
                                        <td style="{{ $style['tbl-padding'] }}text-align: left;"><span
                                                class="text-black fw-bold">Total cost of Works
