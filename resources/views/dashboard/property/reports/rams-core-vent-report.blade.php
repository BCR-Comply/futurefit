...
@section('content')
    <style>
        ...
        table thead tr th:last-child,table thead tr th:first-child,.bg-grasy{
            border-radius: unset !important;
        }
        .d-none {
            display: none;
                ...
                <div class="card-body mybody">
                        ...
                        <div class="cm my-1">
                            ...
                            <div class="row d-flex justify-content-start">
                                @for($i = 1; $i <=7 ; $i++)
                                <div class="col mt-1 mb-1" style="position:relative;pointer-events:none;max-width: max-content;height: max-content;">
                                    <div class="col mt-1 mb-1 pe-0" style="position:relative;pointer-events:none;max-width: max-content;height: max-content;">
                                        <div style="border: 1px solid #333; border-radius: 3px;width:92px;height:92px; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 0px 10px;">
                                            <input type="checkbox" class="inputcheck" id="inputcheck_{{$i}}" name="inputcheck" style="position: absolute;top: 5px;left: 5px;accent-color: #1A47A3;"
