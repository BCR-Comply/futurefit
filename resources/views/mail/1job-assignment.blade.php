...
<div>
    <p>Hi {{$details['title']}}, you have been assigned to  <b>{{$details['property_address']}}</b> for <b>{{$details['assigned_job']}}</b> job.</p>
    <p>
        Within the portal, you will find all works assigned to you, accompanied by supporting documentation. Additionally, you will be able to upload supporting documentation for the completed tasks.
    </p>
    <p>
    ...
    <p>Phone: <b>{{$details['config']['phone'] ?? ''}}</b></p>
    <p>Email: <b>{{$details['config']['email'] ?? ''}}</b></p>
